package com.wenbronk.actvititi03.activiti;
...
//    public void saveModel(@RequestBody Map<String, String> values, @PathVariable String modelId) {
    public void saveModel(@PathVariable("modelId") String modelId, String json_xml, String svg_xml, String name, String description) {
